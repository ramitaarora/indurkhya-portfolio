export default function Contact() {
    return (
        <div id="body-style" className="min-w-screen m-5 flex flex-column justify-center align-center">
            ...
            <div id="contact-form" className="my-3 p-3 w-1/2 m-auto overflow-auto">
                <form>
                    ...
                    <div id="form-input" className="flex flex-row m-auto">
                        <input type="submit" value="Submit" className="text-white border m-auto p-2 hover:bg-slate-900 "></input>
                    </div>
            ...
            <div id="icons" className="flex flex-row justify-evenly my-9 justify-self-end">
                ...
                <a href="https://www.linkedin.com/in/ramitaarora/">
                ...
                <a href="mailto:ramitaarora23@gmail.com">
